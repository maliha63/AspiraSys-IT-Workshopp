...
const scriptURL = 'https://script.google.com/macros/s/AKfycbxRY62UWKP_N9ubzXi3JHFHXMDsMXF473J-z2JGl2eGyGiIQzTkpKO7vIYEBSjBowC0/exec';
...
async function confirmSubmitTask() {
    ...
    const submitBtn = document.querySelector('#submit-modal .modal-btn-submit');
    const originalText = submitBtn.textContent;
    submitBtn.textContent = 'Submitting...';
    submitBtn.disabled = true;

    const taskName = taskConfig[currentTaskIndex].title; // e.g. "Submit TASK 1: Designing a Poster in Canva"

    const formData = new FormData();
    formData.append('Type', 'task_submission');
    formData.append('Full Name', registeredName || 'Unknown');
